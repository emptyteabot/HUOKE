...
export function publicMcpDiscovery() {
  ...
  return {
    ...
    endpoints: {
      ...
      sourceProviders: `${SITE_URL}/api/v2/sources/providers`,
      feedgrabIngest: `${SITE_URL}/api/v2/sources/feedgrab/ingest`,
      publicSourceScoring: `${SITE_URL}/api/v2/sources/score`,
      scraplingFetch: `${SITE_URL}/api/v2/sources/scrapling/fetch`,
